...
/**
 * Implementation of the {@link IStockFetcher} interface that retrieves
 * stock data from the Alpha Vantage API. This class provides methods to
 * fetch closing prices for a given stock symbol over a specified date range,
